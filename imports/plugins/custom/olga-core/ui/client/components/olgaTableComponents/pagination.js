...
import { PaginationButtons } from "../olgaTableComponents";


class OlgaTablePagination extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      ...
      >
        <div className="-center">
          <span className="-pageInfo" style={{color: '#595959'}}>
        ...
        <span style={{ marginTop: '-6px' }} className="-divider">|</span>
        <div className="-next">
          <NextComponent
            onClick={(e) => { // eslint-disable-line no-unused-vars
              if (canNext) {
...
export default OlgaTablePagination;
